...
export interface IProdutoCarrinho extends IProduto {
    // e extends importa todas as propriedades de IProduto
    quantidade: number;
}

export const produtos: IProduto[] = [
    { id: 1, descricao: "Mouse gamer", preco: 439.00, descricaoPreco: "À vista no PIX/Boleto", imagem: "./assets/mouse-3.jpg", quantidadeEstoque: 22 },
